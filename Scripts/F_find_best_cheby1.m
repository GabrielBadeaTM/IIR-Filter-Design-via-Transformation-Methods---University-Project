%
%	File F_FIND_BEST_CHEBY1.M
%
%	Function: F_find_best_cheby1
%
%	Synopsis: [b_cheb, a_cheb, H_cheb, M_found, ok] = ...
%	          F_find_best_cheby1(M, w, omega_p, omega_s, ...
%	                              Delta_p, Delta_s, Max_M)
%
%	Searches for a Chebyshev Type I digital low-pass filter that
...
function [b_cheb, a_cheb, H_cheb, M_found, ok] = F_find_best_cheby1(M, w, omega_p, omega_s, Delta_p, Delta_s, Max_M)
    ...
    % Verificare Initiala
    [b_cheb, a_cheb] = cheby1(M_found, Rp, omega_p/pi);
