%
%	File BUT_FTI_DETAILED.M
%
%	Function: BUT_FTI_DETAILED
%
%	Synopsis: [b,a,M,W_c] = But_FTI_detailed(w_p,w_s,Delta_p,Delta_s,Ts) ; 
%
...
%
%   Similar to the original function, but also outputs minimal order M
%   found, as well as W_c calculated.
%
%
...
%   Modified: Decembre 25, 2025
%

function [B,A,M_found,W_c] = But_FTI_detailed(w_p,w_s,Delta_p,Delta_s,Ts)
