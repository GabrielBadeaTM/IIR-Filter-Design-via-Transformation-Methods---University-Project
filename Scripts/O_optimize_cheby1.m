%
%	File O_OPTIMIZE_CHEBY1.M
%
%	Function: O_optimize_cheby1
%
%	Synopsis: [b_best, a_best, H_best, M_best, w_c_best, scor_best] = ...
%	          O_optimize_cheby1(M_start, w, omega_p, omega_s, ...
%	                            Delta_p, Delta_s)
%
%	Optimizes the design of a digital Chebyshev Type I low-pass
%	filter by searching for the best cutoff frequency and filter
%	order starting from an initial order M_start.
%
%	The function iteratively decreases the filter order while
%	scanning admissible cutoff frequencies in order to maximize
%	a custom performance score subject to design tolerances.
%
...
function [b_best, a_best, H_best, M_best, w_c_best, scor_best] = O_optimize_cheby1(M_start, w, omega_p, omega_s, Delta_p, Delta_s)
